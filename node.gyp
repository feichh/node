...
# sqlite3
  ...
  'includes': [ 'deps/sqlite/common-sqlite.gypi'],
  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        # sqlite
        'src/sqlite/async.h',
        'src/sqlite/database.cc',
        'src/sqlite/database.h',
        'src/sqlite/macros.h',
        'src/sqlite/node_sqlite3.cc',
        'src/sqlite/statement.cc',
        'src/sqlite/statement.h',
        'src/sqlite/threading.h',
      ],
      ...
      'conditions': [
        ...
        [ 'node_use_sqlite=="true"', {
          'dependencies': [ 'deps/sqlite/sqlite3.gyp:sqlite3' ],
        }],
